...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo"  id="navbar1"></a>

      <nav class="navbar" data-navbar>
        <ul class="navbar-list">

          <li class="navbar-item">
            <a href="#home" class="navbar-link" id="nom" data-nav-link>Home</a>
          </li>
    ...
    <article>
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <p class="hero-text" id="texteeeee">Sale up to 40% off today</p>
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="" width="330" height="300" loading="lazy" alt="Cat Food"
                    class="img-cover" id="img1">
                </figure>
